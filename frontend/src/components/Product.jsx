...
const Product = ( {product} ) => {
  return (
    <Card className="my-3 p-3 rounded hover-popup-animation h-auto">
      <Link to={`/product/${product._id}`} className="position-relative d-inline-block">
        <Card.Img src={BASE_URL + product?.variants[0]?.images[0]} variant="top" style={{height:"15rem", objectFit: "cover"}} />
